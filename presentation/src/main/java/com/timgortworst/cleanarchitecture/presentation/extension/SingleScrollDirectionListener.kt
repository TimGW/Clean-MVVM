...
/**
 * with thanks to Christophe Beyls
 * https://bladecoder.medium.com/fixing-recyclerview-nested-scrolling-in-opposite-direction-f587be5c1a04
 *
 * This prevents horizontal swipes registered as vertical
 */
class SingleScrollDirectionListener : RecyclerView.OnScrollListener(),
